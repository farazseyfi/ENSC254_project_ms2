...
void cycle_pipeline(regfile_t* regfile_p, Byte* memory_p, Cache* cache_p, pipeline_regs_t* pregs_p, pipeline_wires_t* pwires_p, bool* ecall_exit)
{
  ...
  if (pwires_p->pcsrc) {
    ...
    // Clear pipeline registers for branch
